var fs = require('hbs/lib/node_modules/fs');
var path = require('hbs/lib/node_modules/path');
var walk = require('hbs/lib/node_modules/walk').walk;
...
function Instance(handlebars) {
  ...
  self.handlebars = handlebars || require('hbs/lib/node_modules/handlebars').create();
